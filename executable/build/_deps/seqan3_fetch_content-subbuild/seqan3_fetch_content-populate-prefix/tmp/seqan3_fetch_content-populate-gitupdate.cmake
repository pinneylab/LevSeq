...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "/wynton/home/kortemme/jzhang1198/code/localcolabfold/colabfold-conda/bin/git" --git-dir=.git rev-parse "${ref}^0"
...
execute_process(
  COMMAND "/wynton/home/kortemme/jzhang1198/code/localcolabfold/colabfold-conda/bin/git" --git-dir=.git show-ref "3.3.0"
  WORKING_DIRECTORY "/wynton/home/kortemme/jzhang1198/code/LevSeq/executable/build/_deps/seqan3_fetch_content-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("3.3.0" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/3.3.0")
...
if(fetch_required)
  ...
  execute_process(
    COMMAND "/wynton/home/kortemme/jzhang1198/code/localcolabfold/colabfold-conda/bin/git" --git-dir=.git fetch --tags --force "origin"
    WORKING_DIRECTORY "/wynton/home/kortemme/jzhang1198/code/LevSeq/executable/build/_deps/seqan3_fetch_content-src"
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    COMMAND "/wynton/home/kortemme/jzhang1198/code/localcolabfold/colabfold-conda/bin/git" --git-dir=.git symbolic-ref -q HEAD
    WORKING_DIRECTORY "/wynton/home/kortemme/jzhang1198/code/LevSeq/executable/build/_deps/seqan3_fetch_content-src"
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "/wynton/home/kortemme/jzhang1198/code/localcolabfold/colabfold-conda/bin/git" --git-dir=.git for-each-ref "--format=%(upstream:short)" "${current_branch}"
      WORKING_DIRECTORY "/wynton/home/kortemme/jzhang1198/code/LevSeq/executable/build/_deps/seqan3_fetch_content-src"
...
execute_process(
  COMMAND "/wynton/home/kortemme/jzhang1198/code/localcolabfold/colabfold-conda/bin/git" --git-dir=.git status --porcelain
  WORKING_DIRECTORY "/wynton/home/kortemme/jzhang1198/code/LevSeq/executable/build/_deps/seqan3_fetch_content-src"
  RESULT_VARIABLE error_code
...
if(need_stash)
  execute_process(
    COMMAND "/wynton/home/kortemme/jzhang1198/code/localcolabfold/colabfold-conda/bin/git" --git-dir=.git stash save --quiet;--include-untracked
    WORKING_DIRECTORY "/wynton/home/kortemme/jzhang1198/code/LevSeq/executable/build/_deps/seqan3_fetch_content-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
...
if(git_update_strategy STREQUAL "CHECKOUT")
  execute_process(
    COMMAND "/wynton/home/kortemme/jzhang1198/code/localcolabfold/colabfold-conda/bin/git" --git-dir=.git checkout "${checkout_name}"
    WORKING_DIRECTORY "/wynton/home/kortemme/jzhang1198/code/LevSeq/executable/build/_deps/seqan3_fetch_content-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
else()
  execute_process(
    COMMAND "/wynton/home/kortemme/jzhang1198/code/localcolabfold/colabfold-conda/bin/git" --git-dir=.git rebase "${checkout_name}"
    WORKING_DIRECTORY "/wynton/home/kortemme/jzhang1198/code/LevSeq/executable/build/_deps/seqan3_fetch_content-src"
    RESULT_VARIABLE error_code
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "/wynton/home/kortemme/jzhang1198/code/localcolabfold/colabfold-conda/bin/git" --git-dir=.git rebase --abort
      WORKING_DIRECTORY "/wynton/home/kortemme/jzhang1198/code/LevSeq/executable/build/_deps/seqan3_fetch_content-src"
    )
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      if(need_stash)
        execute_process(
          COMMAND "/wynton/home/kortemme/jzhang1198/code/localcolabfold/colabfold-conda/bin/git" --git-dir=.git stash pop --index --quiet
          WORKING_DIRECTORY "/wynton/home/kortemme/jzhang1198/code/LevSeq/executable/build/_deps/seqan3_fetch_content-src"
          )
      endif()
      message(FATAL_ERROR "\nFailed to rebase in: '/wynton/home/kortemme/jzhang1198/code/LevSeq/executable/build/_deps/seqan3_fetch_content-src'."
    ...
    execute_process(
      COMMAND "/wynton/home/kortemme/jzhang1198/code/localcolabfold/colabfold-conda/bin/git" --git-dir=.git tag -a
...
if(need_stash)
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "/wynton/home/kortemme/jzhang1198/code/localcolabfold/colabfold-conda/bin/git" --git-dir=.git reset --hard --quiet
      WORKING_DIRECTORY "/wynton/home/kortemme/jzhang1198/code/LevSeq/executable/build/_deps/seqan3_fetch_content-src"
    )
    execute_process(
      COMMAND "/wynton/home/kortemme/jzhang1198/code/localcolabfold/colabfold-conda/bin/git" --git-dir=.git stash pop --quiet
      WORKING_DIRECTORY "/wynton/home/kortemme/jzhang1198/code/LevSeq/executable/build/_deps/seqan3_fetch_content-src"
      RESULT_VARIABLE error_code
    )
    if(error_code)
      ...
      execute_process(
        COMMAND "/wynton/home/kortemme/jzhang1198/code/localcolabfold/colabfold-conda/bin/git" --git-dir=.git reset --hard --quiet ${head_sha}
        WORKING_DIRECTORY "/wynton/home/kortemme/jzhang1198/code/LevSeq/executable/build/_deps/seqan3_fetch_content-src"
      )
      execute_process(
        COMMAND "/wynton/home/kortemme/jzhang1198/code/localcolabfold/colabfold-conda/bin/git" --git-dir=.git stash pop --index --quiet
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/wynton/home/kortemme/jzhang1198/code/LevSeq/executable/build/_deps/seqan3_fetch_content-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
...
if(init_submodules)
  execute_process(
    COMMAND "/wynton/home/kortemme/jzhang1198/code/localcolabfold/colabfold-conda/bin/git" --git-dir=.git submodule update --recursive --init 
    WORKING_DIRECTORY "/wynton/home/kortemme/jzhang1198/code/LevSeq/executable/build/_deps/seqan3_fetch_content-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
